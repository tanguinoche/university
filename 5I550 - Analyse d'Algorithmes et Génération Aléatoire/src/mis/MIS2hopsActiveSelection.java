...
public class MIS2hopsActiveSelection {
	int edgeThreshold;
	...
	private Point pickNextActive() {
		...
		return Tools.maxNeighbors(actives, actives, edgeThreshold); //Prendre l'actif qui a le plus plus de voisins parmi les actifs
	}
